...
namespace Microsoft.SqlDataTools.Model
{
    ...
    public class ScriptParameters : ISqlPackageParameters
    {
        ...
        /// <summary>
        /// Specifies a name value pair for an action-specific property;{PropertyName}={Value}. Refer to the help for a specific action to see that action's property names. Example: sqlpackage.exe /Action:Script /?.
        /// </summary>
        [Description("Specifies a name value pair for an action-specific property;{PropertyName}={Value}. Refer to the help for a specific action to see that action's property names. Example: sqlpackage.exe /Action:Script /?.")]
        ...
        ISqlPackageProperties ISqlPackageParameters.Properties
        {
            ...
            set => ScriptProperties = value as ScriptProperties;
        }
        /// <summary>
