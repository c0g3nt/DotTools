...
namespace Microsoft.SqlDataTools.Model
{
    public class PublishProperties : ISqlPackageProperties
    {
        ...
        /// <summary>
        /// Specifies whether differences in the table partition options will be ignored or updated when you publish to a database. This option applies only to Azure Synapse Analytics SQL pool (data warehouse) databases.
        /// </summary>
